  ...
  return (
    <Stack spacing={1.5}>
      ...
      <Stack direction="row" spacing={1}>
        <TextField size="small" label={t('properties.wizard.newGroupLabel')} value={newGroupLabel} onChange={(e) => onNewGroupLabelChange(e.target.value)} InputProps={{ endAdornment: <InputAdornment position="end"><FieldTooltip helpKey="properties.wizard.fieldHelp.group" /></InputAdornment> }} />
        <Button size="small" variant="outlined" startIcon={<AddIcon />} onClick={onCreateGroup} disabled={!newGroupLabel.trim()}>
          ...
          <Stack spacing={1.5}>
                ...
                {def.numberDisplayHint === 'currency' ? (
                  <>
                      ...
                      <FormControlLabel
                        control={
                          <Switch
                            ...
                            onChange={(e) => onDefChange({ ...def, showCurrencySymbol: e.target.checked })}
                          />
                        }
                    ...
                    <TextField
                      ...
                      onChange={(e) => onDefChange({ ...def, currencyPropertyName: e.target.value || undefined })}
            ...
            {def.type === 'string' && (def.fieldType === 'text' || def.fieldType === 'textarea') ? (
              <TextField
                ...
                onChange={(e) =>
                  onDefChange({ ...def, textDisplayHint: (e.target.value || undefined) as HubSpotPropertyDef['textDisplayHint'] })
                }
            ...
            {def.fieldType === 'calculation_equation' ? (
              <TextField
                ...
                onChange={(e) => onDefChange({ ...def, calculationFormula: e.target.value || undefined })}
                multiline
                minRows={2}
            ...
            <TextField
              ...
              onChange={(e) =>
                onDefChange({ ...def, dataSensitivity: (e.target.value || undefined) as HubSpotPropertyDef['dataSensitivity'] })
              }
