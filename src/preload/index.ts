...
const api: RevOpsApi = {
  ...
  groupRequestDelete: (input) => ipcRenderer.invoke(IpcChannels.groupRequestDelete, input),
  groupChanges: (input) => ipcRenderer.invoke(IpcChannels.groupChanges, input),
  groupApplyChange: (input) => ipcRenderer.invoke(IpcChannels.groupApplyChange, input),
  groupDiscardChange: (input) => ipcRenderer.invoke(IpcChannels.groupDiscardChange, input),
  ...
  propertiesImportPlanningMap: (input) =>
    ipcRenderer.invoke(IpcChannels.propertiesImportPlanningMap, input),
  propertiesApplyPlanningImport: (input) =>
    ipcRenderer.invoke(IpcChannels.propertiesApplyPlanningImport, input),
