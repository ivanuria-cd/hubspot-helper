...
| [SPEC-0006](specs/SPEC-0006-gestion-de-propiedades.md) | Gestión de Propiedades | VALIDADO |
...
| SPEC-0002 | Pantalla de bienvenida, selector de proyectos, menú lateral, topbar, layout principal, router, store de shell | Ningún conector externo; ninguna característica de negocio |
