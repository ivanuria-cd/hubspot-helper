...
| [SPEC-0008](specs/SPEC-0008-gestion-de-formularios.md) | Gestión de Formularios | IMPLEMENTADO (patrón común Drive §15; fix defectos MCP §16.4 —normalize create_definition + forms_discard_change—, 2026-06-18; fix mapeo tipos de campo a Forms API v3 §19 —checkbox/booleancheckbox/date—, 2026-06-19; fix validation requerido en campos email §20 —requiere rebuild MCP—, 2026-06-19; edición de formularios update_form §21 + origen al crear explícito/validado §22 —requiere rebuild MCP—, 2026-06-19; typecheck/e2e + PR en máquina) |
